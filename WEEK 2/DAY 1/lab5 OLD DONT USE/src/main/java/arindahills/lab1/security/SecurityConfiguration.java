...
//    }
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
               ...
               .antMatchers(HttpMethod.GET,"/api/v1/diagnostics/**").hasAuthority("ADMIN")

              .antMatchers(HttpMethod.GET,"/api/v1/posts/**").hasAuthority("USER")
                ...
                .antMatchers(HttpMethod.GET,"/api/v1/comments/**").hasAuthority("USER")
                .antMatchers(HttpMethod.POST,"/api/v1/comments/**").hasAuthority("USER")
                .antMatchers(HttpMethod.PUT,"/api/v1/comments/**").hasAuthority("USER")
                .antMatchers(HttpMethod.DELETE,"/api/v1/comments/**").hasAuthority("USER")
